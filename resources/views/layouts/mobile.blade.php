...
<body class="min-h-screen bg-gradient-to-br from-[#667eea] to-[#4ecdc4] text-white pb-24">
    ...
    {{-- Bottom Navigation --}}
    <nav id="mobile-bottom-nav" class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200 z-50">
        <div class="flex items-center justify-around h-16 max-w-lg mx-auto">
            <a href="{{ route('home') }}" data-turbo-prefetch data-mobile-nav
            ...
            <a href="{{ route('budget.index') }}" data-turbo-prefetch data-mobile-nav data-mobile-nav-prefix="/budget"
            ...
            {{-- FAB --}}
            <a href="{{ route('transactions.create') }}" data-turbo-prefetch class="relative -top-4">
            ...
            <a href="{{ route('transactions.index') }}" data-turbo-prefetch data-mobile-nav data-mobile-nav-prefix="/transactions"
            ...
            <a href="{{ route('stats.index') }}" data-turbo-prefetch data-mobile-nav data-mobile-nav-prefix="/stats"
