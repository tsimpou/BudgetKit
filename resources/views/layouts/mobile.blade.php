...
<body class="min-h-screen bg-gradient-to-br from-[#667eea] to-[#4ecdc4] text-white pb-24">
    ...
    <div id="turbo-loading" class="hidden fixed inset-x-0 top-14 bottom-16 z-40 flex items-center justify-center bg-[#667eea]/30 backdrop-blur-sm">
    ...
    {{-- Bottom Navigation --}}
    <nav id="mobile-bottom-nav" data-turbo-permanent class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200 z-50">
        <div class="flex items-center justify-around h-16 max-w-lg mx-auto">
            <a href="{{ route('home') }}" data-turbo-frame="page-content" data-turbo-prefetch data-mobile-nav
            ...
            <a href="{{ route('budget.index') }}" data-turbo-frame="page-content" data-turbo-prefetch data-mobile-nav data-mobile-nav-prefix="/budget"
            ...
            {{-- FAB --}}
            <a href="{{ route('transactions.create') }}" data-turbo-frame="page-content" data-turbo-prefetch class="relative -top-4">
            ...
            <a href="{{ route('transactions.index') }}" data-turbo-frame="page-content" data-turbo-prefetch data-mobile-nav data-mobile-nav-prefix="/transactions"
            ...
            <a href="{{ route('stats.index') }}" data-turbo-frame="page-content" data-turbo-prefetch data-mobile-nav data-mobile-nav-prefix="/stats"
